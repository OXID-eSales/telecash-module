...
$aLang = [
    ...
    'OSC_TELECASH_TXNTYPE_' . Module::TELECASH_TXN_TYPE_PREAUTH                    => 'Autorisierung',
    'OSC_TELECASH_TXNTYPE_' . Module::TELECASH_TXN_TYPE_POSTAUTH                   => 'nachträglicher Einzug',
    ...
    'OSC_TELECASH_OID'                     => 'TeleCash Bestell ID (OID)',
    ...
    'OSC_TELECASH_CHARGE_HEAD'             => 'Geld einziehen',
    'OSC_TELECASH_CHARGE_NOTE'             => 'Es ist möglich, einen Teil oder die ganze Summe der Bestellung einzuziehen.',
    'OSC_TELECASH_CHARGE_LABEL'            => 'Preis (%s)',
    'OSC_TELECASH_CHARGE_TITLE'            => 'Bitte geben Sie einen Wert zwischen 0 und %s ein.',
    'OSC_TELECASH_CHARGE_SUBMIT'           => 'Betrag einziehen.',
    'OSC_TELECASH_CHARGE_SUBMIT_HELP'      => 'Klicken Sie hier um den eingegebenen Betrag einzuziehen.',
];