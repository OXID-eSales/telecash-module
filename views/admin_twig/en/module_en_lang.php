...
$aLang = [
    ...
    'OSC_TELECASH_TXNTYPE_' . Module::TELECASH_TXN_TYPE_PREAUTH                    => 'Authorize',
    'OSC_TELECASH_TXNTYPE_' . Module::TELECASH_TXN_TYPE_POSTAUTH                   => 'Subsequent collect',
    ...
    'OSC_TELECASH_CHARGE_HEAD'             => 'Capture funds',
    'OSC_TELECASH_CHARGE_NOTE'             => 'It is possible to capture part or all of the order amount.',
    'OSC_TELECASH_CHARGE_LABEL'            => 'Price (%s)',
    'OSC_TELECASH_CHARGE_TITLE'            => 'Please enter a value between 0 and %s.',
    'OSC_TELECASH_CHARGE_SUBMIT'           => 'Collect the amount.',
    'OSC_TELECASH_CHARGE_SUBMIT_HELP'      => 'Click here to collect the entered amount.',
];