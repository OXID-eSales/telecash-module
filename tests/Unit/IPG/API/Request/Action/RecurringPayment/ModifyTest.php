...
class ModifyTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testXMLGeneration(string $orderId, Payment $payment, RecurringPaymentInformation $paymentInformation): void
    {
        $prophet = new Prophet();
    ...
    {
        return [
            ['8934htgien g34hgigh30gj50o', new Payment('abc-def', 2), new RecurringPaymentInformation(new \DateTime(), 1, 1, RecurringPaymentInformation::PERIOD_MONTH)],
        ];
    }
}
